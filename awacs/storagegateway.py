...
CancelCacheReport = Action("CancelCacheReport")
...
DeleteCacheReport = Action("DeleteCacheReport")
...
DescribeCacheReport = Action("DescribeCacheReport")
...
StartCacheReport = Action("StartCacheReport")
