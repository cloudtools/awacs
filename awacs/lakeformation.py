...
GetTemporaryGluePartitionCredentials = Action("GetTemporaryGluePartitionCredentials")
GetTemporaryGlueTableCredentials = Action("GetTemporaryGlueTableCredentials")
...
RegisterResourceWithPrivilegedAccess = Action("RegisterResourceWithPrivilegedAccess")
