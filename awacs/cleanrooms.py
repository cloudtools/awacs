...
GetProtectedJob = Action("GetProtectedJob")
...
ListProtectedJobs = Action("ListProtectedJobs")
...
StartProtectedJob = Action("StartProtectedJob")
...
UpdateProtectedJob = Action("UpdateProtectedJob")
