...
AddCollectionToCollectionGroup = Action("AddCollectionToCollectionGroup")
BatchGetCollection = Action("BatchGetCollection")
BatchGetCollectionGroup = Action("BatchGetCollectionGroup")
...
CreateCollectionGroup = Action("CreateCollectionGroup")
...
DeleteCollectionGroup = Action("DeleteCollectionGroup")
...
ListCollectionGroups = Action("ListCollectionGroups")
...
UpdateCollectionGroup = Action("UpdateCollectionGroup")
