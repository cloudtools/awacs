...
CreateCustomModelDeployment = Action("CreateCustomModelDeployment")
CreateDataAutomationLibrary = Action("CreateDataAutomationLibrary")
...
CreatePromptRouter = Action("CreatePromptRouter")
...
DeleteDataAutomationLibrary = Action("DeleteDataAutomationLibrary")
DeleteDataAutomationProject = Action("DeleteDataAutomationProject")
DeleteDataSource = Action("DeleteDataSource")
DeleteEnforcedGuardrailConfiguration = Action("DeleteEnforcedGuardrailConfiguration")
...
DeletePromptRouter = Action("DeletePromptRouter")
...
GetDataAutomationLibrary = Action("GetDataAutomationLibrary")
GetDataAutomationLibraryEntity = Action("GetDataAutomationLibraryEntity")
GetDataAutomationLibraryIngestionJob = Action("GetDataAutomationLibraryIngestionJob")
...
GetExecutionFlowSnapshot = Action("GetExecutionFlowSnapshot")
GetFlow = Action("GetFlow")
GetFlowAlias = Action("GetFlowAlias")
GetFlowExecution = Action("GetFlowExecution")
...
InvokeDataAutomationLibraryIngestionJob = Action(
...
ListDataAutomationLibraries = Action("ListDataAutomationLibraries")
ListDataAutomationLibraryEntities = Action("ListDataAutomationLibraryEntities")
ListDataAutomationLibraryIngestionJobs = Action(
...
ListEnforcedGuardrailsConfiguration = Action("ListEnforcedGuardrailsConfiguration")
ListEvaluationJobs = Action("ListEvaluationJobs")
ListFlowAliases = Action("ListFlowAliases")
ListFlowExecutionEvents = Action("ListFlowExecutionEvents")
ListFlowExecutions = Action("ListFlowExecutions")
...
PutEnforcedGuardrailConfiguration = Action("PutEnforcedGuardrailConfiguration")
...
StopFlowExecution = Action("StopFlowExecution")
...
UpdateCustomModelDeployment = Action("UpdateCustomModelDeployment")
UpdateDataAutomationLibrary = Action("UpdateDataAutomationLibrary")
