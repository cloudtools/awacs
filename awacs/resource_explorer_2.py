...
CreateResourceExplorerSetup = Action("CreateResourceExplorerSetup")
CreateStreamingAccessForService = Action("CreateStreamingAccessForService")
CreateView = Action("CreateView")
DeleteIndex = Action("DeleteIndex")
DeleteResourceExplorerSetup = Action("DeleteResourceExplorerSetup")
DeleteResourcePolicy = Action("DeleteResourcePolicy")
DeleteStreamingAccessForService = Action("DeleteStreamingAccessForService")
...
GetResourceExplorerSetup = Action("GetResourceExplorerSetup")
GetResourcePolicy = Action("GetResourcePolicy")
GetServiceIndex = Action("GetServiceIndex")
GetServiceView = Action("GetServiceView")
...
ListServiceIndexes = Action("ListServiceIndexes")
ListServiceViews = Action("ListServiceViews")
ListStreamingAccessForServices = Action("ListStreamingAccessForServices")
