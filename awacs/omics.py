...
CancelRunBatch = Action("CancelRunBatch")
...
DeleteRunBatch = Action("DeleteRunBatch")
...
ListRunsInBatch = Action("ListRunsInBatch")
...
StartRunBatch = Action("StartRunBatch")
