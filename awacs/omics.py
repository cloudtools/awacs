...
CreateWorkflowVersion = Action("CreateWorkflowVersion")
...
DeleteWorkflowVersion = Action("DeleteWorkflowVersion")
...
GetWorkflowVersion = Action("GetWorkflowVersion")
...
UpdateWorkflowVersion = Action("UpdateWorkflowVersion")
