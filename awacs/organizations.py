...
DescribeResponsibilityTransfer = Action("DescribeResponsibilityTransfer")
...
InviteOrganizationToTransferResponsibility = Action(
...
ListAccountsWithInvalidEffectivePolicy = Action(
...
ListEffectivePolicyValidationErrors = Action("ListEffectivePolicyValidationErrors")
...
ListInboundResponsibilityTransfers = Action("ListInboundResponsibilityTransfers")
ListOrganizationalUnitsForParent = Action("ListOrganizationalUnitsForParent")
ListOutboundResponsibilityTransfers = Action("ListOutboundResponsibilityTransfers")
...
TerminateResponsibilityTransfer = Action("TerminateResponsibilityTransfer")
UntagResource = Action("UntagResource")
UpdateOrganizationalUnit = Action("UpdateOrganizationalUnit")
UpdatePolicy = Action("UpdatePolicy")
UpdateResponsibilityTransfer = Action("UpdateResponsibilityTransfer")
