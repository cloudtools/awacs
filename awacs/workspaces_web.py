...
AssociateSessionLogger = Action("AssociateSessionLogger")
...
CreateSessionLogger = Action("CreateSessionLogger")
...
DeleteSessionLogger = Action("DeleteSessionLogger")
...
DisassociateSessionLogger = Action("DisassociateSessionLogger")
...
GetSessionLogger = Action("GetSessionLogger")
...
ListSessionLoggers = Action("ListSessionLoggers")
...
UpdateSessionLogger = Action("UpdateSessionLogger")
