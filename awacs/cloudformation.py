...
CreateChangeSet = Action(prefix, 'CreateChangeSet')
DeleteChangeSet = Action(prefix, 'DeleteChangeSet')
DescribeChangeSet = Action(prefix, 'DescribeChangeSet')
ExecuteChangeSet = Action(prefix, 'ExecuteChangeSet')
ListChangeSets = Action(prefix, 'ListChangeSets')
