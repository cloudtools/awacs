...
CreateStackRefactor = Action("CreateStackRefactor")
...
DescribeStackRefactor = Action("DescribeStackRefactor")
...
ExecuteStackRefactor = Action("ExecuteStackRefactor")
GetGeneratedTemplate = Action("GetGeneratedTemplate")
GetHookResult = Action("GetHookResult")
...
ListAllHookResults = Action("ListAllHookResults")
...
ListStackRefactorActions = Action("ListStackRefactorActions")
ListStackRefactors = Action("ListStackRefactors")
