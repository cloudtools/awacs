...
BatchGetCommandExecutions = Action("BatchGetCommandExecutions")
...
BatchGetSandboxes = Action("BatchGetSandboxes")
...
ListCommandExecutionsForSandbox = Action("ListCommandExecutionsForSandbox")
...
ListSandboxes = Action("ListSandboxes")
ListSandboxesForProject = Action("ListSandboxesForProject")
...
StartCommandExecution = Action("StartCommandExecution")
StartSandbox = Action("StartSandbox")
StartSandboxConnection = Action("StartSandboxConnection")
StopBuild = Action("StopBuild")
StopBuildBatch = Action("StopBuildBatch")
StopSandbox = Action("StopSandbox")
