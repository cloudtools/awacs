...
CreateDataIntegrationSchedule = Action("CreateDataIntegrationSchedule")
...
GetDataIntegrationExecution = Action("GetDataIntegrationExecution")
GetDataIntegrationSchedule = Action("GetDataIntegrationSchedule")
...
ListDataIntegrationExecutions = Action("ListDataIntegrationExecutions")
ListDataIntegrationSchedules = Action("ListDataIntegrationSchedules")
...
StartDataIntegrationExecution = Action("StartDataIntegrationExecution")
...
UpdateDataIntegrationSchedule = Action("UpdateDataIntegrationSchedule")
