...
DeleteDomainVerification = Action("DeleteDomainVerification")
...
GetDomainVerification = Action("GetDomainVerification")
...
ListDomainVerifications = Action("ListDomainVerifications")
...
StartDomainVerification = Action("StartDomainVerification")
