...
CreateQuotaShare = Action("CreateQuotaShare")
...
DeleteQuotaShare = Action("DeleteQuotaShare")
...
DescribeQuotaShare = Action("DescribeQuotaShare")
...
ListQuotaShares = Action("ListQuotaShares")
