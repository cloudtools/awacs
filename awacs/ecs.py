...
CreateExpressGatewayService = Action("CreateExpressGatewayService")
...
DeleteDaemon = Action("DeleteDaemon")
DeleteDaemonTaskDefinition = Action("DeleteDaemonTaskDefinition")
DeleteExpressGatewayService = Action("DeleteExpressGatewayService")
...
DescribeDaemon = Action("DescribeDaemon")
DescribeDaemonDeployments = Action("DescribeDaemonDeployments")
DescribeDaemonRevisions = Action("DescribeDaemonRevisions")
DescribeDaemonTaskDefinition = Action("DescribeDaemonTaskDefinition")
DescribeExpressGatewayService = Action("DescribeExpressGatewayService")
...
ListDaemonDeployments = Action("ListDaemonDeployments")
ListDaemonTaskDefinitions = Action("ListDaemonTaskDefinitions")
...
PutSystemLogEvents = Action("PutSystemLogEvents")
RegisterContainerInstance = Action("RegisterContainerInstance")
RegisterDaemonTaskDefinition = Action("RegisterDaemonTaskDefinition")
...
StopServiceDeployment = Action("StopServiceDeployment")
...
UpdateDaemon = Action("UpdateDaemon")
UpdateExpressGatewayService = Action("UpdateExpressGatewayService")
