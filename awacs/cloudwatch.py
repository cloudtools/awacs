...
GetAlarmMuteRule = Action("GetAlarmMuteRule")
...
GetOTelEnrichment = Action("GetOTelEnrichment")
...
Link = Action("Link")
ListAlarmMuteRules = Action("ListAlarmMuteRules")
...
PutAlarmMuteRule = Action("PutAlarmMuteRule")
...
StartOTelEnrichment = Action("StartOTelEnrichment")
StopMetricStreams = Action("StopMetricStreams")
StopOTelEnrichment = Action("StopOTelEnrichment")
