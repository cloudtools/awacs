...
GenerateRecommendedPolicyV2 = Action("GenerateRecommendedPolicyV2")
...
GetRecommendedPolicyV2 = Action("GetRecommendedPolicyV2")
...
GetUsageV2 = Action("GetUsageV2")
InviteMembers = Action("InviteMembers")
ListAccountUsageV2 = Action("ListAccountUsageV2")
