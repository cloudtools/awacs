...
CreateAndAttachS3AccessPoint = Action("CreateAndAttachS3AccessPoint")
...
DescribeS3AccessPointAttachments = Action("DescribeS3AccessPointAttachments")
...
DetachAndDeleteS3AccessPoint = Action("DetachAndDeleteS3AccessPoint")
