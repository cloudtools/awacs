...
DeleteSigningConfiguration = Action("DeleteSigningConfiguration")
DeregisterPullTimeUpdateExclusion = Action("DeregisterPullTimeUpdateExclusion")
...
DescribeImageSigningStatus = Action("DescribeImageSigningStatus")
...
GetSigningConfiguration = Action("GetSigningConfiguration")
InitiateLayerUpload = Action("InitiateLayerUpload")
ListImages = Action("ListImages")
ListPullTimeUpdateExclusions = Action("ListPullTimeUpdateExclusions")
...
PutSigningConfiguration = Action("PutSigningConfiguration")
RegisterPullTimeUpdateExclusion = Action("RegisterPullTimeUpdateExclusion")
...
UpdateImageStorageClass = Action("UpdateImageStorageClass")
