...
GetEventConfiguration = Action("GetEventConfiguration")
...
ListInsightsData = Action("ListInsightsData")
...
PutEventConfiguration = Action("PutEventConfiguration")
...
SearchSampleQueries = Action("SearchSampleQueries")
