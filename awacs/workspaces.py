...
CreateRootClientCertificate = Action("CreateRootClientCertificate")
...
DeleteRootClientCertificate = Action("DeleteRootClientCertificate")
...
DescribeRootClientCertificates = Action("DescribeRootClientCertificates")
...
DirectoryAccessManagement = Action("DirectoryAccessManagement")
...
ModifyEndpointEncryptionMode = Action("ModifyEndpointEncryptionMode")
...
UpdateRootClientCertificate = Action("UpdateRootClientCertificate")
