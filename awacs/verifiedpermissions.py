...
CreatePolicyStoreAlias = Action("CreatePolicyStoreAlias")
...
DeletePolicyStoreAlias = Action("DeletePolicyStoreAlias")
...
GetPolicyStoreAlias = Action("GetPolicyStoreAlias")
...
ListPolicyStoreAliases = Action("ListPolicyStoreAliases")
