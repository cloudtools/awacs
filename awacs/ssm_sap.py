...
GetConfigurationCheckOperation = Action("GetConfigurationCheckOperation")
...
ListConfigurationCheckDefinitions = Action("ListConfigurationCheckDefinitions")
ListConfigurationCheckOperations = Action("ListConfigurationCheckOperations")
ListDatabases = Action("ListDatabases")
ListOperationEvents = Action("ListOperationEvents")
ListOperations = Action("ListOperations")
ListSubCheckResults = Action("ListSubCheckResults")
ListSubCheckRuleResults = Action("ListSubCheckRuleResults")
...
StartConfigurationChecks = Action("StartConfigurationChecks")
