...
CreateSpendingLimit = Action("CreateSpendingLimit")
DeleteSpendingLimit = Action("DeleteSpendingLimit")
...
SearchSpendingLimits = Action("SearchSpendingLimits")
TagResource = Action("TagResource")
UntagResource = Action("UntagResource")
UpdateSpendingLimit = Action("UpdateSpendingLimit")
