...
GetDelegatedAccessToken = Action("GetDelegatedAccessToken")
...
GetWebIdentityToken = Action("GetWebIdentityToken")
SetContext = Action("SetContext")
SetSourceIdentity = Action("SetSourceIdentity")
TagGetWebIdentityToken = Action("TagGetWebIdentityToken")
