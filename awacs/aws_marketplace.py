...
CreateVerificationEvidence = Action("CreateVerificationEvidence")
...
GetIssuedTaxInvoice = Action("GetIssuedTaxInvoice")
...
GetVerificationEvidence = Action("GetVerificationEvidence")
...
ListIssuedTaxInvoices = Action("ListIssuedTaxInvoices")
...
ListVerificationEvidence = Action("ListVerificationEvidence")
ListVerifications = Action("ListVerifications")
...
UpdateVerificationEvidence = Action("UpdateVerificationEvidence")
