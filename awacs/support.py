...
DescribeCaseOptions = Action("DescribeCaseOptions")
...
GetInteraction = Action("GetInteraction")
InitiateCallForCase = Action("InitiateCallForCase")
InitiateChatForCase = Action("InitiateChatForCase")
InitiateLiveContactForCase = Action("InitiateLiveContactForCase")
ListInteractionEntries = Action("ListInteractionEntries")
ListInteractions = Action("ListInteractions")
...
ResolveInteraction = Action("ResolveInteraction")
SearchForCases = Action("SearchForCases")
StartInteraction = Action("StartInteraction")
UpdateCaseSeverity = Action("UpdateCaseSeverity")
UpdateInteraction = Action("UpdateInteraction")
