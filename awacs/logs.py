...
CreateImportTask = Action("CreateImportTask")
...
CreateLookupTable = Action("CreateLookupTable")
...
DeleteLookupTable = Action("DeleteLookupTable")
DeleteMetricFilter = Action("DeleteMetricFilter")
DeletePipelineRule = Action("DeletePipelineRule")
...
DescribeImportTaskBatches = Action("DescribeImportTaskBatches")
...
DescribeLookupTables = Action("DescribeLookupTables")
...
DisassociateSourceFromS3TableIntegration = Action(
...
GetLogFields = Action("GetLogFields")
GetLogGroupFields = Action("GetLogGroupFields")
GetLogRecord = Action("GetLogRecord")
GetLookupTable = Action("GetLookupTable")
GetQueryResults = Action("GetQueryResults")
GetScheduledQuery = Action("GetScheduledQuery")
GetScheduledQueryHistory = Action("GetScheduledQueryHistory")
GetTransformer = Action("GetTransformer")
IntegrateWithS3Table = Action("IntegrateWithS3Table")
Link = Action("Link")
ListAggregateLogGroupSummaries = Action("ListAggregateLogGroupSummaries")
...
ListLogGroups = Action("ListLogGroups")
...
ListSourcesForS3TableIntegration = Action("ListSourcesForS3TableIntegration")
...
PutLogGroupDeletionProtection = Action("PutLogGroupDeletionProtection")
PutMetricFilter = Action("PutMetricFilter")
PutPipelineRule = Action("PutPipelineRule")
...
UpdateLookupTable = Action("UpdateLookupTable")
