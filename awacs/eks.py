...
DescribeCapability = Action("DescribeCapability")
...
DescribeInsightsRefresh = Action("DescribeInsightsRefresh")
...
ListDashboardData = Action("ListDashboardData")
ListDashboardResources = Action("ListDashboardResources")
...
MutateViaKubernetesApi = Action("MutateViaKubernetesApi")
RegisterCluster = Action("RegisterCluster")
StartInsightsRefresh = Action("StartInsightsRefresh")
