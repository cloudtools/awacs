...
CreateAdConfiguration = Action("CreateAdConfiguration")
...
DeleteAdConfiguration = Action("DeleteAdConfiguration")
...
GetAdConfiguration = Action("GetAdConfiguration")
...
InsertAdBreak = Action("InsertAdBreak")
ListAdConfigurations = Action("ListAdConfigurations")
...
ListParticipantReplicas = Action("ListParticipantReplicas")
...
StartParticipantReplication = Action("StartParticipantReplication")
StartViewerSessionRevocation = Action("StartViewerSessionRevocation")
StopComposition = Action("StopComposition")
StopParticipantReplication = Action("StopParticipantReplication")
StopStream = Action("StopStream")
TagResource = Action("TagResource")
UntagResource = Action("UntagResource")
UpdateAdConfiguration = Action("UpdateAdConfiguration")
